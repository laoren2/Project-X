...
struct RunningTrackCreateView: View {
    ...
    @State var terrainType: RunningTrackTerrainType = .other
    ...
    let types = [
        RunningTrackTerrainType.road,
        RunningTrackTerrainType.mountain
    ]
            ...
            Form {
                Section {
                    Button("普通赛道") {
                        ...
                        name_en = "Track 1"
                        name_ko = "코스 1"
                        singleRegisterCardID = "cpasset_0c362d5b"
                        teamRegisterCardID = "cpasset_5c82bf06"
                    }
                }
                Section {
                    Button("高级赛道") {
                        ...
                        name_ko = "고급 코스 1"
                        singleRegisterCardID = "cpasset_f5de93df"
                        teamRegisterCardID = "cpasset_560ceaa8"
                    }
                }
...
struct RunningTrackUpdateView: View {
    ...
    func updateTrack() {
        ...
        if !viewModel.name_ko.isEmpty { name_i18n["en"] = viewModel.name_ko }
...
struct RunningTrackCardView: View {
    ...
    func settledTrackLeaderboard() {
        guard var components = URLComponents(string: "/competition/running/settle_leaderboard") else { return }
        components.queryItems = [
