...
struct BikeRouteTrainingRecordDetailView: View {
    @EnvironmentObject var appState: AppState
    @StateObject var viewModel: BikeRouteTrainingRecordDetailViewModel
    ...
    init(recordID: String) {
        _viewModel = StateObject(wrappedValue: BikeRouteTrainingRecordDetailViewModel(recordID: recordID))
    }
    ...
    private func adjustNavigationPath() {
        ...
        if let index = appState.navigationManager.path.firstIndex(where: { $0.string == "routeTrainingRealtimeView" }) {
...
struct RunningRouteTrainingRecordDetailView: View {
    @EnvironmentObject var appState: AppState
    @StateObject var viewModel: RunningRouteTrainingRecordDetailViewModel
    ...
    init(recordID: String) {
        _viewModel = StateObject(wrappedValue: RunningRouteTrainingRecordDetailViewModel(recordID: recordID))
    }
